=== Piggy - High Converting Add To Cart Popup For WooCommerce ===
Contributors: piggy
Donate link: https://piggy.com
...
### 🚀 Your WooCommerce Store Is Only As Good As Your Cart Experience

**Piggy is a [WooCommerce Add To Cart Popup](https://piggy.com/?utm_source=Link&utm_campaign=Readme&utm_medium=WP%20Repo&utm_term=Homepage), that helps every shop owner improve their user experience, increase conversions & maximize profits.**

This plugin allows you to show an elegant drawer/side cart each time a new product is added to the cart.

[Homepage](https://piggy.com/?utm_source=Link&utm_campaign=Readme&utm_medium=WP%20Repo&utm_term=Homepage) | [Live Demo](https://piggy.com/?utm_source=Link&utm_campaign=Readme&utm_medium=WP%20Repo&utm_term=Live%20Demo)
...
[Learn more about Piggy features](https://piggy.com/?utm_source=Link&utm_campaign=Readme&utm_medium=WP%20Repo&utm_term=Learn%20more%20about%20Piggy%20features)

### ✨ A Pixel Perfect WooCommerce Cart
Piggy makes your cart accessible from anywhere on your site and looks great on any theme or design.
...
### 🤝 Integrations
Al though Piggy is compatible with most plugins. We have dedicated integrations with the following plugins:
...
- [WooCommerce Mix & Match Products](https://woocommerce.com/products/woocommerce-mix-and-match-products/).
...
We get it, you’re running a brand. It’s important that customers feel at home. That’s why we made it really easy to customize every single color and make it your own. Piggy even has presets, to inspire and get you started! 🌈
...
The Cart Launcher shortcode `[piggy_cart_launcher]`  enables you to place a WooCommerce cart icon in your menu or anywhere on your page.
...
- Show or Hide the cart’s current subtotal
- If you own a Piggy Pro license, you'll also have access to the Elementor widget for even more advanced styling and control.
...
- **🌍 Translation Ready:** The Piggy codebase is ready to translate into your language.
- **🙌 Custom CSS and JS:** Add custom code on the fly that gets loaded after the plugin's code. No more `!important`.
...
## Pro Features
Whilst the free version is rich in features. With the Pro version you can take your WooCommerce cart to the next level. Here's a breakdown of some of the features you get access to if you upgrade.

[Explore Piggy features](https://piggy.com/?utm_source=Link&utm_campaign=Readme&utm_medium=WP%20Repo&utm_term=Explore%20Piggy%20features)
...
With this widget, you can easily style the Cart Launcher and show it anywhere you'd like. Take control of all the styling elements like text color, background color, hover effect, shadow, border, and much more!

**[👉 Get Piggy Pro today](https://piggy.com/?utm_source=Link&utm_campaign=Readme&utm_medium=WP%20Repo&utm_term=👉%20Get%20Piggy%20Pro%20today)**

---

== Installation ==

1. Upload `piggy.zip` to the `/wp-content/plugins/` directory
...
1. 🚀 Piggy in action!
2. 🎨 Over 24 individual color settings
3. ⚡️ Choose from multiple triggers (pro)
4. 👋 Recommend products to your customers inside the cart
...
[Click here to view the changelog](https://docs.piggy.com/changelog)