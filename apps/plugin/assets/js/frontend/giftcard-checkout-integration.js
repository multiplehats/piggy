...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   LeatApiError: () => (/* reexport safe */ _src_queries__WEBPACK_IMPORTED_MODULE_4__.LeatApiError),\n/* harmony export */   api: () => (/* reexport safe */ _src_api__WEBPACK_IMPORTED_MODULE_3__.api),\n/* harmony export */   claimReward: () => (/* reexport safe */ _src_queries__WEBPACK_IMPORTED_MODULE_4__.claimReward),\n/* harmony export */   claimSpendRule: () => (/* reexport safe */ _src_queries__WEBPACK_IMPORTED_MODULE_4__.claimSpendRule),\n/* harmony export */   clickOutsideAction: () => (/* reexport safe */ _svelte_actions__WEBPACK_IMPORTED_MODULE_2__.clickOutsideAction),\n/* harmony export */   getContact: () => (/* reexport safe */ _src_queries__WEBPACK_IMPORTED_MODULE_4__.getContact),\n/* harmony export */   getCoupons: () => (/* reexport safe */ _src_queries__WEBPACK_IMPORTED_MODULE_4__.getCoupons),\n/* harmony export */   getEarnRules: () => (/* reexport safe */ _src_queries__WEBPACK_IMPORTED_MODULE_4__.getEarnRules),\n/* harmony export */   getGiftcardBalance: () => (/* reexport safe */ _src_queries__WEBPACK_IMPORTED_MODULE_4__.getGiftcardBalance),\n/* harmony export */   getSpendRules: () => (/* reexport safe */ _src_queries__WEBPACK_IMPORTED_MODULE_4__.getSpendRules),\n/* harmony export */   getTiers: () => (/* reexport safe */ _src_queries__WEBPACK_IMPORTED_MODULE_4__.getTiers),\n/* harmony export */   handleEscapeAction: () => (/* reexport safe */ _svelte_actions__WEBPACK_IMPORTED_MODULE_2__.handleEscapeAction),\n/* harmony export */   joinProgram: () => (/* reexport safe */ _src_queries__WEBPACK_IMPORTED_MODULE_4__.joinProgram),\n/* harmony export */   outboundUrl: () => (/* reexport safe */ _outbound_url__WEBPACK_IMPORTED_MODULE_0__[\"default\"]),\n/* harmony export */   replaceStrings: () => (/* reexport safe */ _replace_strings__WEBPACK_IMPORTED_MODULE_1__.replaceStrings),\n/* harmony export */   trapFocusAction: () => (/* reexport safe */ _svelte_actions__WEBPACK_IMPORTED_MODULE_2__.trapFocusAction)\n/* harmony export */ });\n/* harmony import */ var _outbound_url__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./outbound-url */ \"../../packages/lib/outbound-url.ts\");\n/* harmony import */ var _replace_strings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./replace-strings */ \"../../packages/lib/replace-strings.ts\");\n/* harmony import */ var _svelte_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./svelte-actions */ \"../../packages/lib/svelte-actions/index.ts\");\n/* harmony import */ var _src_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./src/api */ \"../../packages/lib/src/api.ts\");\n/* harmony import */ var _src_queries__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./src/queries */ \"../../packages/lib/src/queries/index.ts\");\n/* harmony import */ var _src_queries_types__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./src/queries/types */ \"../../packages/lib/src/queries/types.ts\");\n\n\n\n\n\n\n\n\n//# sourceURL=webpack://@leat/plugin/../../packages/lib/index.ts?");
...
/***/ "../../packages/lib/src/queries/index.ts":
/*!***********************************************!*\
  !*** ../../packages/lib/src/queries/index.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   LeatApiError: () => (/* binding */ LeatApiError),\n/* harmony export */   claimReward: () => (/* binding */ claimReward),\n/* harmony export */   claimSpendRule: () => (/* binding */ claimSpendRule),\n/* harmony export */   getContact: () => (/* binding */ getContact),\n/* harmony export */   getCoupons: () => (/* binding */ getCoupons),\n/* harmony export */   getEarnRules: () => (/* binding */ getEarnRules),\n/* harmony export */   getGiftcardBalance: () => (/* binding */ getGiftcardBalance),\n/* harmony export */   getSpendRules: () => (/* binding */ getSpendRules),\n/* harmony export */   getTiers: () => (/* binding */ getTiers),\n/* harmony export */   joinProgram: () => (/* binding */ joinProgram)\n/* harmony export */ });\n/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../api */ \"../../packages/lib/src/api.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\nclass LeatApiError extends Error {\n    constructor(status, statusText, data) {\n        super(`LeatApiError: ${statusText}`);\n        Object.defineProperty(this, \"status\", {\n            enumerable: true,\n            configurable: true,\n            writable: true,\n            value: void 0\n        });\n        Object.defineProperty(this, \"statusText\", {\n            enumerable: true,\n            configurable: true,\n            writable: true,\n            value: void 0\n        });\n        Object.defineProperty(this, \"data\", {\n            enumerable: true,\n            configurable: true,\n            writable: true,\n            value: void 0\n        });\n        Object.defineProperty(this, \"message\", {\n            enumerable: true,\n            configurable: true,\n            writable: true,\n            value: void 0\n        });\n        this.status = status;\n        this.statusText = statusText;\n        this.data = data;\n        this.message = data;\n    }\n}\nfunction getCoupons(userId) {\n    return __awaiter(this, void 0, void 0, function* () {\n        const endpoint = \"/leat/v1/coupons\";\n        const url = userId !== null ? `${endpoint}?userId=${userId}` : endpoint;\n        const { data, error } = yield _api__WEBPACK_IMPORTED_MODULE_0__.api.get(url);\n        if (error) {\n            throw new LeatApiError(error.status, error.statusText, error.data);\n        }\n        return data;\n    });\n}\nfunction getContact(userId) {\n    return __awaiter(this, void 0, void 0, function* () {\n        const endpoint = \"/leat/v1/contact\";\n        const url = `${endpoint}?userId=${userId}`;\n        const { data, error } = yield _api__WEBPACK_IMPORTED_MODULE_0__.api.get(url);\n        if (error) {\n            throw new LeatApiError(error.status, error.statusText, error.data);\n        }\n        return data;\n    });\n}\nfunction getTiers() {\n    return __awaiter(this, void 0, void 0, function* () {\n        const { data, error } = yield _api__WEBPACK_IMPORTED_MODULE_0__.api.get(\"/leat/v1/tiers\");\n        if (error) {\n            throw new LeatApiError(error.status, error.statusText, error.data);\n        }\n        return data;\n    });\n}\nfunction claimReward(earnRuleId, userId) {\n    return __awaiter(this, void 0, void 0, function* () {\n        const { data, error } = yield _api__WEBPACK_IMPORTED_MODULE_0__.api.post(\"/leat/v1/earn-reward\", {\n            userId,\n            earnRuleId,\n        });\n        if (error) {\n            if (error) {\n                throw new LeatApiError(error.status, error.statusText, error.data);\n            }\n            throw new Error(\"No data returned\");\n        }\n        return data;\n    });\n}\nfunction getEarnRules() {\n    return __awaiter(this, void 0, void 0, function* () {\n        const { data, error } = yield _api__WEBPACK_IMPORTED_MODULE_0__.api.get(\"/leat/v1/earn-rules\");\n        if (error) {\n            throw new LeatApiError(error.status, error.statusText, error.data);\n        }\n        return data;\n    });\n}\nfunction getSpendRules(userId) {\n    return __awaiter(this, void 0, void 0, function* () {\n        const endpoint = \"/leat/v1/spend-rules\";\n        const url = userId !== null ? `${endpoint}?userId=${userId}` : endpoint;\n        const { data, error } = yield _api__WEBPACK_IMPORTED_MODULE_0__.api.get(url);\n        if (error) {\n            throw new LeatApiError(error.status, error.statusText, error.data);\n        }\n        return data;\n    });\n}\nfunction joinProgram(userId) {\n    return __awaiter(this, void 0, void 0, function* () {\n        const { data, error } = yield _api__WEBPACK_IMPORTED_MODULE_0__.api.post(\"/leat/v1/join-program?g\", {\n            userId,\n        });\n        if (error) {\n            throw new LeatApiError(error.status, error.statusText, error.data);\n        }\n        return data;\n    });\n}\nfunction claimSpendRule(spendRuleId, userId) {\n    return __awaiter(this, void 0, void 0, function* () {\n        const { data, error } = yield _api__WEBPACK_IMPORTED_MODULE_0__.api.post(`/leat/v1/spend-rules-claim`, {\n            userId,\n            id: spendRuleId,\n        });\n        if (error || !data) {\n            if (error) {\n                throw new LeatApiError(error.status, error.statusText, error.data);\n            }\n            throw new Error(\"No data returned\");\n        }\n        return data;\n    });\n}\nfunction getGiftcardBalance(couponCode) {\n    return __awaiter(this, void 0, void 0, function* () {\n        const { data, error } = yield _api__WEBPACK_IMPORTED_MODULE_0__.api.post(`/leat/v1/giftcards`, {\n            couponCode,\n        });\n        if (error || !data) {\n            if (error) {\n                throw new LeatApiError(error.status, error.statusText, error.data);\n            }\n            throw new Error(\"No data returned\");\n        }\n        return data;\n    });\n}\n\n\n//# sourceURL=webpack://@leat/plugin/../../packages/lib/src/queries/index.ts?");

/***/ }),

/***/ "../../packages/lib/src/queries/types.ts":
/*!***********************************************!*\
  !*** ../../packages/lib/src/queries/types.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n\n\n\n//# sourceURL=webpack://@leat/plugin/../../packages/lib/src/queries/types.ts?");
