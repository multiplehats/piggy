...
abstract class AbstractStoreApiExtensionType implements StoreApiExtensionTypeInterface {
	 ...
	 */
	public function __construct( ExtendSchema $extend, SchemaController $schema_controller, Options $options ) {
		$this->extend            = $extend;
	...
	protected function get_cart_instance() {
		if ( ! function_exists( 'WC' ) ) {
			throw new \Exception( __( 'WooCommerce function does not exist.', 'piggy' ) );
		}
