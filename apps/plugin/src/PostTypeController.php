...
final class PostTypeController {
	...
	public function register_promotion_rules_post_type() {
		$labels = array(
			'name'                  => _x( 'Promotions', 'Post type general name', 'leat-crm' ),
			'singular_name'         => _x( 'Promotion', 'Post type singular name', 'leat-crm' ),
			'menu_name'             => _x( 'Promotions', 'Admin Menu text', 'leat-crm' ),
			'name_admin_bar'        => _x( 'Promotion', 'Add New on Toolbar', 'leat-crm' ),
			'add_new'               => __( 'Add New', 'leat-crm' ),
			'add_new_item'          => __( 'Add New Promotion', 'leat-crm' ),
			'new_item'              => __( 'New Promotion', 'leat-crm' ),
			'edit_item'             => __( 'Edit Promotion', 'leat-crm' ),
			'view_item'             => __( 'View Promotion', 'leat-crm' ),
			'all_items'             => __( 'All Promotions', 'leat-crm' ),
			'search_items'          => __( 'Search Promotions', 'leat-crm' ),
			'parent_item_colon'     => __( 'Parent Promotions:', 'leat-crm' ),
			'not_found'             => __( 'No promotions found.', 'leat-crm' ),
			'not_found_in_trash'    => __( 'No promotions found in Trash.', 'leat-crm' ),
			'featured_image'        => _x( 'Promotion Cover Image', 'Overrides the "Featured Image" phrase for this post type. Added in 4.3', 'leat-crm' ),
			'set_featured_image'    => _x( 'Set cover image', 'Overrides the "Set featured image" phrase for this post type. Added in 4.3', 'leat-crm' ),
			'remove_featured_image' => _x( 'Remove cover image', 'Overrides the "Remove featured image" phrase for this post type. Added in 4.3', 'leat-crm' ),
			'use_featured_image'    => _x( 'Use as cover image', 'Overrides the "Use as featured image" phrase for this post type. Added in 4.3', 'leat-crm' ),
			'archives'              => _x( 'Promotion archives', 'The post type archive label used in nav menus. Default "Post Archives". Added in 4.4', 'leat-crm' ),
			'insert_into_item'      => _x( 'Insert into promotion', 'Overrides the "Insert into post"/"Insert into page" phrase (used when inserting media into a post). Added in 4.4', 'leat-crm' ),
			'uploaded_to_this_item' => _x( 'Uploaded to this promotion', 'Overrides the "Uploaded to this post/page" phrase (used when viewing media attached to a post). Added in 4.4', 'leat-crm' ),
			'filter_items_list'     => _x( 'Filter promotions list', 'Screen reader text for the filter links heading on the post type listing screen. Default "Filter posts list"/"Filter pages list". Added in 4.4', 'leat-crm' ),
			'items_list_navigation' => _x( 'Promotions list navigation', 'Screen reader text for the pagination heading on the post type listing screen. Default "Posts list navigation"/"Pages list navigation". Added in 4.4', 'leat-crm' ),
			'items_list'            => _x( 'Promotions list', 'Screen reader text for the items list heading on the post type listing screen. Default "Posts list"/"Pages list". Added in 4.4', 'leat-crm' ),
		);
