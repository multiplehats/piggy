...
class WCProductsSearch extends AbstractRoute
{
    ...
    public function get_args()
    {
        return [
			...
			[
				...
				'args'                => [
					'term' => [
						'description' => __( 'Search term', 'piggy' ),
						'type'        => 'string',
					],
					'limit' => [
						'description' => __( 'Limit', 'piggy' ),
						'type'        => 'integer',
					],
					'include' => [
						'description' => __( 'Include IDs', 'piggy' ),
						'type'        => 'array',
						'items'       => [
							'type' => 'integer',
						],
					...
					'exclude' => [
						'description' => __( 'Exclude IDs', 'piggy' ),
						'type'        => 'array',
						'items'       => [
							'type' => 'integer',
						],
    ...
    protected function get_route_post_response(\WP_REST_Request $request)
    {
        ...
        $response_objects = array_filter($response_objects, function ($item) {
            return !empty($item);
        });
