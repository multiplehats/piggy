	...
	protected function get_route_post_response( \WP_REST_Request $request ) {
		...
		$post_data = array(
			...
			'meta_input' => array(
				...
				'_piggy_spend_rule_piggy_tier_uuids' => $data['piggyTierUuids'],
				...
				'_piggy_spend_rule_points' => $data['credits'],
				'_piggy_spend_rule_social_handle' => $data['socialHandle'],
				'_piggy_spend_rule_excluded_collection_ids' => $data['excludedCollectionIds'],
				'_piggy_spend_rule_excluded_product_ids' => $data['excludedProductIds'],
				'_piggy_spend_rule_min_order_subtotal_cents' => $data['minimumOrderAmount'],
			)
		);
