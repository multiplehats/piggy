...
import { ApiErrorResponse } from '../type-defs';
/**
...
export type CanMakePaymentReturnType = boolean | Promise<boolean | { error: { message: string } }>;

export type CanMakePaymentCallback = (cartData: CanMakePaymentArgument) => CanMakePaymentReturnType;
...
export type PaymentMethods = Record<string, PaymentMethodConfigInstance> | EmptyObjectType;
...
export interface PaymentResult {
	message: string;
	paymentStatus: CheckoutResponseSuccess['payment_result']['payment_status'] | 'not set';
